 ...
 * @author Erwin_Yoga
 */
@WebServlet(name = "LoadMenuSellingReport", urlPatterns = {"/LoadMenuSellingReport"})
public class LoadMenuSellingReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            List<Object[]> results = orderDetailsFacade.countMenuItemsByStallName(stallName);

            request.setAttribute("menuCounts", results);
            
            request.getRequestDispatcher("menusellingreport.jsp").include(request, response);     
        }
    }
